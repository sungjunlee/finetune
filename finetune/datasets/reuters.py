...
if __name__ == "__main__":
    ...
    model = SequenceLabeler(verbose=True, class_weights={'Named Entity': 2}, low_memory_mode=True, batch_size=2, n_epochs=10, lr_warmup=0.1, chunk_long_sequences=True, tensorflow_folder='.tensor-crf')
